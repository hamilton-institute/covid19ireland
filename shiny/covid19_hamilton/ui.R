    ...
    tabItem(tabName = 'sources',
            helpText(h4("Data sources:"),
                     ...
                     h4(fa(name = "user-plus", fill = "#FFFFFF", height = 20),
                        a("Interventions data", href= "https://data.humdata.org/dataset/e1a91ae0-292d-4434-bc75-bf863d4608ba/resource/93108e8e-8afc-4f26-950b-0c1e587ee5c2/download/20200416-acaps-covid-19-goverment-measures-dataset-v8.xlsx")),
              ...
              column(width = 3,
                     pickerInput("sel_horiz",
                                 ...
                                 choices=c('Cumulative cases', 'Cumulative deaths', 
                                           ...
                                           'Daily cases', 'Sqrt daily cases', 'Log daily cases',
                                           'Daily deaths', 'Sqrt daily deaths', 'Log daily deaths',
