            ...
            gradientBox(
              ...
              footer = column(
                ...
                fluidRow(
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC1Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ),
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC2Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC3Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC4Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC5Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC6Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC7Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
                  ...
                  column(
                    width = 3,
                    valueBoxOutput("IrelandC8Box", width = NULL) %>%
                      withSpinner(
                        type =  3, color = "#152b42", size = 0.5,
                        color.background = "white"
                      )
...
sidebar  <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem(text = "Forecast",  tabName = "forecast",
             ...
             menuSubItem("Interval Estimate",  tabName = "plots",
                         icon = icon("fas fa-chart-line")),
             menuSubItem("Point Estimate",  tabName = "plots2",
